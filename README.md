...
Relational Databases store all the resources that the client needs acccess to, SQL is a way of talking to the databases and getting resources back, editing resources, and adding new ones.

- [x] Why do tables need a `primary key`?

All resources need a unique identifier just in case there are resources that look similar but are actually distinct.
...
We need a table in between those two tables to reference both primary keys of each table.
